...
_exception_handler:
    ...
    /* Debug: Store exception cause */
    l.mtspr r0, r4, 0x1234  /* Store exception cause in a debug SPR */
...
main:
    ...
    /* Ensure TLB is not busy (force a miss) */
    l.mfspr r6, r0, 0x1801  /* Read IMMU TLB Config */
    l.ori r6, r6, 0x0  /* Ensure no reload is happening */
    l.mtspr r0, r6, 0x1801  /* Write back to IMMU */
    ...
    /* Ensure bus access is done (dummy store before fault) */
    l.addi r7, r0, 0x1234
    l.sw   0(r5), r7  /* This should fail and complete bus access */

    /* Access invalid memory (should trigger `except_ipagefault`) */
